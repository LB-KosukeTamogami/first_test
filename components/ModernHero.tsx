      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[70vh] lg:min-h-[80vh]">
          ...
          <div className="relative lg:order-last animate-fade-in">
            ...
            <div className="hidden md:block absolute -top-6 -left-6 bg-card border border-border rounded-xl p-4 shadow-lg animate-scale-in">
            ...
            <div className="hidden md:block absolute -bottom-6 -right-6 bg-card border border-border rounded-xl p-4 shadow-lg animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center gap-3">
